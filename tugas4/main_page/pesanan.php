...
<head>
    ...
    <style>
        ...
        /* --- STYLE BARU: LAYOUT CHECKBOX & KATEGORI --- */
        .checkbox-group {
            display: flex;
        ...
        /* Label kategori (Sewa Alat / Layanan Wisata) */
        .category-label {
            font-weight: 700;
        ...
        .checkbox-group label { 
            display: flex;                  
            justify-content: space-between; /* Teks kiri, Checkbox kanan mentok */
        ...
        /* Wrapper untuk teks agar Nama dan Harga menumpuk vertikal */
        .label-text {
            display: flex;
            flex-direction: column;
            text-align: left;
        ...
        <form action="proses_pesan.php" method="POST" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <div class="checkbox-group">
                    ...
                    <div class="category-label">Sewa Alat Outdoor</div>

                    <label>
                        <div class="label-text">
                            <span class="item-name">Tenda Dome 4P</span>
                            <span class="item-price">Rp 50.000</span>
                        </div>
                        <input type="checkbox" id="srv_tenda" name="layanan[]" value="Tenda" onclick="hitungTotal()">
                    </label>

                    <label>
                        <div class="label-text">
                            <span class="item-name">Sleeping Bag</span>
                            <span class="item-price">Rp 15.000</span>
                        </div>
                        <input type="checkbox" id="srv_sleeping" name="layanan[]" value="Sleeping Bag" onclick="hitungTotal()">
                    </label>

                    <label>
                        <div class="label-text">
                            <span class="item-name">Paket Masak</span>
                            <span class="item-price">Rp 25.000</span>
                        </div>
                        <input type="checkbox" id="srv_masak" name="layanan[]" value="Paket Masak" onclick="hitungTotal()">
                    </label>

                    <hr style="margin: 10px 0; border: 0; border-top: 1px dashed #ddd;">

                    <div class="category-label">Layanan Wisata</div>

                    <label>
                        <div class="label-text">
                            <span class="item-name">Tiket Kawah Putih</span>
                            <span class="item-price">Rp 31.000</span>
                        </div>
                        <input type="checkbox" id="srv_kawah" name="layanan[]" value="Kawah Putih" onclick="hitungTotal()">
                    </label>

                    <label>
                        <div class="label-text">
                            <span class="item-name">Tiket Orchid Forest</span>
                            <span class="item-price">Rp 40.000</span>
                        </div>
                        <input type="checkbox" id="srv_orchid" name="layanan[]" value="Orchid Forest" onclick="hitungTotal()">
                    </label>

                    <label>
                        <div class="label-text">
                            <span class="item-name">Tiket Sunrise Cukul</span>
                            <span class="item-price">Rp 15.000</span>
                        </div>
                        <input type="checkbox" id="srv_sunrise" name="layanan[]" value="Sunrise Point" onclick="hitungTotal()">
                    </label>
